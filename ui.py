...
class AppUI:
    ...
    def __init__(self, page: ft.Page):
        # Lưu tham chiếu page để dùng ở nhiều chỗ
        self.page = page

        # Thiết lập cửa sổ và style cơ bản của page
        self.page.title = "Emotion Detector"
        self.page.window_width = 900
        self.page.window_height = 600
        # Canh dọc trung tâm (giúp giao diện nằm giữa cửa sổ)
        self.page.vertical_alignment = ft.MainAxisAlignment.CENTER
        # Màu nền tối cho theme (nền tối + chữ sáng)
